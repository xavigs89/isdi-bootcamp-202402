...
var person = new Person('Pepito', 42, 176, 90, 'male', 'white', 'redhead')


console.log('CASE PERSON EAT');




console.log('PERSON MOVE walk-run-stop');


console.log('PERSON AWAKE awake-sleep');
